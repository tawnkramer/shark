...
//get time in seconds between two calls to s_clock()
static double get_sec_diff(int64_t a, int64_t b)
{
    uint64_t elapsed_ms = a - b;
    return (double)elapsed_ms * (1.0 / 1000.0);
}
